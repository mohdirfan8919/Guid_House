...
export default class SelectedFiltersInMultipleSelectionComponent extends React.Component{
  constructor(props){
    super(props);
        ...
        <span>
          {
            filterKeys.map(val => {
              if(this.state[val].constructor === String){
                return(
                  <span className="selected-advanced-filter-in-multiple-selection" key={val}>
